...
public:
	...
	const unsigned int getCurrentFramesPerSecond() const { return m_currentFramesPerSecond; }
	const unsigned int getAverageFramesPerSecond() const { return m_averageFramesPerSecond; }
	const float getCurrentFramesPerSecondf() const { return m_currentFramesPerSecondFloat; }
	const float getAverageFramesPerSecondf() const { return m_averageFramesPerSecondFloat; }
