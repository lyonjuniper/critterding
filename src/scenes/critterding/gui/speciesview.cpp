...
Speciesview::Speciesview()
 : Panel(false)
 , m_recalc_interval(100) // fixme feed fps to this
...
// 		if ( m_recalc_count >= m_recalc_interval )
		...
		textprinter->print( getPosition().m_x+col1, y, titlePos.c_str() );
		textprinter->print( getPosition().m_x+col2, y, titleColor.c_str() );
		textprinter->print( getPosition().m_x+col3, y, titleNum.c_str() );
		textprinter->print( getPosition().m_x+col4, y, titleAd.c_str() );
		textprinter->print( getPosition().m_x+col5, y, titleNeurons.c_str() );
		textprinter->print( getPosition().m_x+col6, y, titleSynapses.c_str() );
		textprinter->print( getPosition().m_x+col7, y, titleBodyparts.c_str() );
...
// 			const Genotype* g2 = genotypes->list[i];
			...
			textprinter->print( getPosition().m_x+col6, y, totalSyns );
			textprinter->print( getPosition().m_x+col7, y, g->bodyArch->archBodyparts.size() );
		}
