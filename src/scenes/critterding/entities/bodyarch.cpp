...
const bool BodyArch::faceIsTaken( const archBodypart& archbodypart, const unsigned int face ) const
{
...
const bool BodyArch::findOpenFace( unsigned int& bodypart, unsigned int& face ) const
{
...
// 	if ( OneOrTwo == 1 )
// 	{
// 		co->XYZ1 = randgen->Instance()->get( 0, 4 );
...
const unsigned int BodyArch::getUniqueBodypartID()
{
...
const unsigned int BodyArch::getUniqueConstraintID()
{
	unsigned int id = 1000;
	bool found = true;
	while ( found )
